...
class urp_courses:
    ...
    def __init__(self, username, password):
        ...
        self.usercourse_url = 'http://zhjw.dlnu.edu.cn/xkAction.do?actionType=17'
	self.webusercourse_url = 'http://zhjw.dlnu.edu.cn/xkAction.do?actionType=17'
    ...
    def get_webusercourse(self):
	soup = u'获取信息失败，请稍后再试'
	if self.login():
	    r = self.s.get(self.webusercourse_url)
